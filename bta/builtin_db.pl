...
is_safe_built_in(is(_,B), ground(B)).
...
is_built_in_literal(num(_X)).   /* declarative if delays until nonvar */
...
is_built_in_literal(write(_,_)).   	/* not declarative */
is_built_in_literal(write_term(_,_)).   	/* not declarative */
is_built_in_literal(format(_,_,_)).   	/* not declarative */
...
is_built_in_literal(see(_)).
is_built_in_literal(seen).
